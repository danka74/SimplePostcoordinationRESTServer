...
public class SyntaxCheckResource extends ServerResource {

	private static Logger log = Logger.getLogger(SyntaxCheckResource.class);
	...
	public Representation checkExpression(Representation entity) {
