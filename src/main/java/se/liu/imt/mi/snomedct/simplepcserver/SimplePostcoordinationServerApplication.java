...
public class SimplePostcoordinationServerApplication extends Application {

	private static final Logger log = Logger
			.getLogger(SimplePostcoordinationServerApplication.class);
	private static Configuration config = null;

	public SimplePostcoordinationServerApplication(Context context) {
		super(context);
	}
	public static void main(String[] args) throws Exception {
		...
		component.getDefaultHost().attach(new SimplePostcoordinationServerApplication(sharedContext));
