...
public class SimplePostcoordinationApplication extends Application {
	...
	public SimplePostcoordinationApplication(Context context) {
		super(context);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		HashMap<Long, Boolean> concepts = SNOMEDCTGraph
				.loadSnomedCTConcepts(config.getString("snomed.snomed-file"));
		Context sharedContext = component.getContext().createChildContext();
		sharedContext.getAttributes().put("concepts", concepts);

		component.getDefaultHost().attach(
				new SimplePostcoordinationApplication(sharedContext));
		component.start();
